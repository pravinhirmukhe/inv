                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('purchase_no', (isset($_POST['purchase_no']) ? $_POST['purchase_no'] : $purchase->purchase_no), 'class="form-control input-tip" id="purchase_no"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("lr_no", "lr_no") ?>
                                <?php echo form_input('lr_no', (isset($_POST['lr_no']) ? $_POST['lr_no'] : $purchase->lr_no), 'class="form-control input-tip" id="lr_no"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("ag_order_no", "ag_order_no") ?>
                                <?php echo form_input('ag_order_no', (isset($_POST['ag_order_no']) ? $_POST['ag_order_no'] : $purchase->ag_order_no), 'class="form-control input-tip" id="lr_no"'); ?>
                            </div>
                        </div>
                        <div class="col-md-12">
