...
<html>
    <head>
        ...
        <link href="<?= $assets ?>js/jtable/jquery-ui-1.8.16.custom.css" rel="stylesheet" type="text/css" />
        ...
        <link href="<?= $assets ?>bower_components/bootstrap-fileinput/css/fileinput.min.css" rel="stylesheet"/>

        <script type="text/javascript" src="<?= $assets ?>js/jquery-2.0.3.min.js"></script>
        <script type="text/javascript" src="<?= $assets ?>js/jquery-migrate-1.2.1.min.js"></script>
        <script type="text/javascript" src="<?= $assets ?>bower_components/bootstrap-fileinput/js/fileinput.min.js"></script>
        ...
        <div id="app_wrapper">
            <header id="header" class="navbar">
                <div class="container">
                    ...
                    <a href="#" id="main-menu-act" class="full visible-md visible-lg"><i class="fa fa-bars"></i></a>
                    ...
                    <div class="header-nav">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <?php } ?>
                            <?php if ($events) { ?>
                                <li class="dropdown hidden-xs"><a class="btn tip" title="<?= lang('calendar') ?>" data-placement="left" href="#" data-toggle="dropdown"><i
                            ...
                            <li class="dropdown hidden-sm">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="bwhite noPadding">
                                        <a href="#" id="fixed" class=""><i class="fa fa-angle-double-left"></i> 
                                            <span id="fixedText">Fixed</span></a> 
                                        <a href="#" id="cssLight" class="grey">
                                            <i class="fa fa-stop"></i> Grey</a> 
                                        <a href="#" id="cssBlue" class="blue">
                                            <i class="fa fa-stop"></i> Blue</a> 
                                        <a href="#" id="cssBlack" class="black"><i class="fa fa-stop"></i> Black</a>
                                    </li>
                                ...
                                <li class="mm_welcome"><a href="<?= site_url() ?>"><i class="fa fa-dashboard"></i><span
                                    ...
                                    <li class="mm_products">
                                        ...
                                        <ul>
                                            ...
                                            <!--                                            <li id="products_challan"><a class="submenu"
                                                                                                                     href="<?= site_url('products/products_challan'); ?>"><i
                                                                                                    class="fa fa-filter"></i><span
                                                                                                    class="text"> <?= lang('products_challan'); ?></span></a></li>-->
                                    ...
                                    <li class="mm_purchases">
                                        <a class="dropmenu" href="#"><i class="fa fa-cart-plus"></i><span
                                    ...
                                    <li class="mm_transfers">
                                        <a class="dropmenu" href="#"><i class="fa fa-exchange"></i><span
                                    ...
                                    <li class="mm_auth mm_customers mm_suppliers mm_billers mm_employee">
                                        ...
                                        <ul>
                                            ...
                                            <li id="employee_index"><a class="submenu" href="<?= site_url('employee'); ?>"><i
                                                        class="fa fa-users"></i><span
                                                        class="text"> <?= lang('list_employee'); ?></span></a></li>
                                            <li id="employee_index"><a class="submenu" href="<?= site_url('employee/add'); ?>"
                                                                       data-toggle="modal" data-target="#myModal"><i
                                                        class="fa fa-plus-circle"></i><span
                                                        class="text"> <?= lang('add_employee'); ?></span></a></li>
                                        </ul>
                                    </li>
                                    <li class="mm_notifications"><a class="submenu" href="<?= site_url('notifications'); ?>"><i
                                        ...
                                        <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) != 'settings' ? '' : 'mm_pos' ?>">
                                            ...
                                            <ul>
                                                ...
                                                <li id="products_para"><a class="submenu"
                                                                          href="<?= site_url('system_settings/products_para'); ?>"><i
                                                            class="fa fa-bars"></i><span
                                                            class="text"> <?= lang('products_para'); ?></span></a></li>
                                                <li id="products_discount"><a class="submenu" href="<?= site_url('system_settings/products_discounts'); ?>">
                                                        <i class="fa fa-bars"></i><span class="text"> <?= lang('products_discount'); ?></span></a></li>
                                                <li id="min_qty_lvl"><a class="submenu" href="<?= site_url('system_settings/min_qty_level'); ?>">
                                                        <i class="fa fa-bars"></i><span class="text"> <?= lang('min_qty_level'); ?></span></a></li>
                                            </ul>
                                        </li>
                                    <?php } ?>
                                    <li class="mm_reports">
