                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="checkbox" value="1" id="products-challan" class="checkbox"
                                                   name="products-challan" <?php echo $p->{'products-challan'} ? "checked" : ''; ?>><label
                                                   for="products-challan" class="padding05"><?= lang('products_challan') ?></label>
                                        </td>
                                    </tr>
