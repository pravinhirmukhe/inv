...
<div class="box" ng-controller="editProducts">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i><?= lang('edit_product'); ?></h2>
    </div>
    <div class="box-content" ng-init='prod =<?= json_encode($product) ?>'>
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
                        ...
                        <?php
                        echo form_input('store_id', (isset($_POST['store_id']) ? $_POST['store_id'] : ($product ? $product->store_id : '')), 'class="form-control" default-attrib data-tab="companies" id="companies" placeholder="' . lang("select") . " " . lang("store") . '" required="required" style="width:100%" ng-model="prod.store_id" ');
                        ?>
                    </div>
                    <div class="form-group all">
                ...
                <div class="col-md-6 col-md-offset-1">
                    ...
                    <div class="form-group all">
                        ...
                        <?= form_input('name', (isset($_POST['name']) ? $_POST['name'] : ($product ? $product->name : '')), 'class="form-control" id="name" required="required" readonly'); ?>
                    </div>
                    <div class="form-group all">
                    ...
                    <div class="form-group standard">
                        ...
                        <div class="row" >
                            <div class="col-md-3" ><?php
                                ...
                                ?></div>
                            <div class="col-md-2"><input type="text" name="colorqty" value="<?= (isset($_POST['colorqty']) ? $_POST['colorqty'] : ($product ? $product->colorqty : '')) ?>" class="form-control" id='colorqty' ng-model="prod.colorqty" ng-change="getQty('#colorqty')"/></div>
                        </div>
                    </div>
                    <div class="form-group all">
                        <?= lang("Size", "size") ?>
                        <div class="row" ng-init="prod.sizeangle = '<?= (isset($_POST['sizeangle']) ? $_POST['sizeangle'] : ($product ? $product->sizeangle : '')) ?>'">
                            ...
                            <div class="col-md-3"> &nbsp;&nbsp;<input icheck type="radio" name="sizeangle" <?= (isset($_POST['sizeangle']) && $_POST['sizeangle'] == "" ? "checked='checked'" : ($product && $product->sizeangle == "" ? "checked='checked'" : '')) ?> value=""/>&nbsp;&nbsp;&nbsp;&nbsp;No Size</div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-4" ng-init='size =<?= json_encode($sizes) ?>;
                                            prod.singlesize = "<?= $product->size ?>"'>
                                <div class="col-md-9" style="padding: 0px" ><?php
                                    ...
                                    ?>
                                </div><div class="col-md-2"> {{size[prod.singlesize].code}}"</div>
                            ...
                            <div class="form-group all">
                                ...
                                foreach ($warehouses as $warehouse) {
                                    ...
                                    if ($this->Settings->racks) {
                                        ...
                                        echo form_hidden('wh_' . $warehouse->id, $warehouse->id) . form_input('wh_qty_' . $warehouse->id, (isset($_POST['wh_qty_' . $warehouse->id]) ? $_POST['wh_qty_' . $warehouse->id] : $this->sma->formatQuantity($product->quantity)), 'class="form-control" id="wh_qty_' . $warehouse->id . '" placeholder="' . lang('quantity') . '" ng-model="prod.quantity" onlyno readonly');
...
//                                    echo '</div>';
                    ...
                    <div class="row all">
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                ...
                                <?= form_dropdown('cper', $per, (isset($_POST['cper']) ? $_POST['cper'] : ($product ? $product->cper : '')), 'class="form-control select" id="cper" placeholder="' . lang("select") . " " . lang("Unit") . '" required="required" style="width:100%"'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group all">
                                ...
                                <?= form_dropdown('pper', $per, (isset($_POST['pper']) ? $_POST['pper'] : ($product ? $product->pper : '')), 'class="form-control select" id="pper" placeholder="' . lang("select") . " " . lang("Unit") . '" required="required" style="width:100%"'); ?>
                            </div>
                        </div>
                    </div>
                    <!--                    <div class="standard">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <?php echo form_submit('edit_product', "Update", 'class="btn btn-primary"'); ?>
                    </div>
                </div>
                <?= form_close(); ?>
            </div>
...
<?php
if ($combo_items) {
    echo 'var ci = ' . json_encode($combo_items) . ';$.each(ci, function() { add_product_item(this); });';
}
?>
...
<?php if ($product) { ?>
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "<?= site_url('products/getSubCategories') ?>/0",
                dataType: "json",
                success: function (scdata) {
                    if (scdata != null) {
                        $("#subcategory").select2("destroy").empty().attr("placeholder", "<?= lang('select_subcategory') ?>").select2({
