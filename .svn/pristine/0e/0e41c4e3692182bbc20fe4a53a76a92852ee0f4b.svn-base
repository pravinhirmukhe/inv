...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Add New Product Discount</h4>
        </div>
        <?php
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="margin">Discount(in % only)</label>
                            <div class="controls"> 
                                <?php echo form_input('discount', '', 'class="form-control" id="margin" data-bv-notempty="true"'); ?>
                            </div>
                        </div>
...
//            $data += "&name=<?= $this->security->get_csrf_token_name() ?>&value=<?= $this->security->get_csrf_hash() ?>";
            $.ajax({
                url: "<?= site_url('system_settings/AddAjaxProduct_discount/?v=1') ?>",
