...
//                                    echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $Settings->default_biller), 'id="biller" data-placeholder="' . lang("select") . ' ' . lang("biller") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                    echo form_input('biller', (isset($_POST['biller']) ? $_POST['biller'] : $Settings->default_biller), ' default-attrib data-tab="companies" data-id="0" id="companies" class="form-control" placeholder="' . lang("select") . ' ' . lang("biller") . '" required="required" style="width:100%;"');
                                    ?>
                                </div>
