        ...
        <div class="col-lg-12">
            <div class="box">
                ...
                <div class="box-content">
                    ...
                    <div class="col-lg-1 col-md-2 col-xs-6">
                        <a class="bdpink white quick-button small" href="<?= site_url('suppliers') ?>">
                            <i class="fa fa-users"></i>
                    ...
                    <div class="col-lg-1 col-md-2 col-xs-6">
                        <a class="blightBlue white quick-button small" href="<?= site_url('products/products_challan') ?>">
                            <i class="fa fa-shopping-bag"></i>

                            <p><?= lang('products_challan') ?></p>
                            <!--<span class="notification green">4</span>-->
                        </a>
                    </div>
                    <?php if ($Owner) { ?>
        ...
        <div class="col-lg-12">
            <div class="box">
                ...
                <div class="box-content">
                    ...
                    <?php } if ($GP['products_challan']) { ?>
                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="bbrown white quick-button small" href="<?= site_url('products/products_challan') ?>">
                                <i class="fa fa-shopping-bag"></i>
