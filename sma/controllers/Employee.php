...
class Employee extends MY_Controller {
    ...
    function getEmployees() {
        ...
        $this->datatables
                ->select("id,id,photo,joining_date,CONCAT('fname',' ','mname',' ','lname') as name,email,mobile")
                ->from("employee")
    ...
    function add() {
        ...
        if ($this->form_validation->run('employee/add') == true) {
        ...
        if ($this->form_validation->run() == true && $sid = $this->companies_model->addCompany($data)) {
            ...
            $this->load->view($this->theme . 'employee/add', $this->data);
        }
    }
