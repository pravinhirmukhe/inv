...
<div class="box" ng-controller="purchaseCode">
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("supplier_bill_no", "poref"); ?>
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : ""), 'class="form-control input-tip" id="poref"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("purchase_no", "poref"); ?>
                                <?php echo form_input('purchase_no', (isset($_POST['purchase_no']) ? $_POST['purchase_no'] : ""), 'class="form-control input-tip" id="purchase_no"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("lr_no", "lr_no") ?>
                                <?php echo form_input('lr_no', (isset($_POST['lr_no']) ? $_POST['lr_no'] : $ponumber), 'class="form-control input-tip" id="lr_no"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("ag_order_no", "ag_order_no") ?>
                                <?php echo form_input('ag_order_no', (isset($_POST['ag_order_no']) ? $_POST['ag_order_no'] : $ponumber), 'class="form-control input-tip" id="ag_order_no"'); ?>
                            </div>
                        </div>
                        <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if ($Owner || $Admin || $GP['suppliers-add']) { ?>
                                                ...
                                                <input type="hidden" name="supplier" value="" id="posupplier"
                                                       ...
                                                       placeholder="<?= lang("select") . ' ' . lang("supplier") ?>" onchange="getDiscountme()">
                            ...
                            <div class="row" id="extras-con" style="display: none;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('discount', '', 'class="form-control input-tip" id="podiscount" ng-model="pur.discount"'); ?>
                                    </div>
                                </div>
