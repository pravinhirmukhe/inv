...
<div class="modal-dialog modal-md">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Add New Product Special Discount</h4>
        </div>
        <?php
        $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id' => 'addParaForm');
        echo form_open_multipart("system_settings/saveProd_Spe_Dis", $attrib);
        ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="controls"> 
                            <?php echo form_input('product_code', '', 'class="form-control myselect" id="barcode" placeholder="Select Barcode" data-bv-notempty="true"'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="product_name">Item Name</label>
                        <div class="controls"> 
                            <?php echo form_input('product_name', '', 'class="form-control myselect"  id="product_name" readonly data-bv-notempty="true"'); ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="controls"> 
                            <?php echo form_input('mrp', '', 'class="form-control myselect"  id="mrp" readonly data-bv-notempty="true"'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="margin">Margin</label>
                        <div class="controls"> 
                            <?php echo form_input('margin', '', 'class="form-control myselect"  id="margin" readonly '); ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="controls"> 
                            <?php echo form_input('purchase_rate', '', 'class="form-control myselect"  id="purchase_rate" readonly data-bv-notempty="true"'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="old_discount">Old Discount</label>
                        <div class="controls"> 
                            <?php echo form_input('old_discount', '', 'class="form-control myselect"  id="old_discount" readonly'); ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="controls"> 
                            <?php echo form_input('special_discount', '', 'class="form-control myselect"  id="special_discount" data-bv-notempty="true"'); ?>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-footer">
            <?php echo form_submit('addPara', "Save", 'class="btn btn-primary"'); ?>
        </div>
        </form>
    </div>
</div>
