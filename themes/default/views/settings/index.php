...
<!--                        <div class="alert alert-warning" role="alert"><p><strong>Cron Job:</strong> <code>0 1 * * * wget
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <?php
                            echo form_hidden('reg_ver', '0');
                            echo form_hidden('allow_reg', '0');
                            echo form_hidden('reg_notification', '0');
                            ?>
                            <!--                    <div class="col-md-4">
                                                    <div class="form-group">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <?php
                                        $ref = array(1 => lang('prefix_year_no'), 2 => lang('prefix_month_year_no'), 3 => lang('sequence_number_4'), 4 => lang('sequence_number_6'), 5 => lang('random_number'));
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <?= form_input('barcode_prefix', $Settings->barcode_prefix, 'class="form-control tip" id="barcode_prefix"'); ?>
                                                        </div>
                                                    </div>-->
                        </fieldset>
